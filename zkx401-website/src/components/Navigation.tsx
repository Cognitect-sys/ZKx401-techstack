...
export default function Navigation() {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-250 ${
      isScrolled 
        ? 'bg-background-near-black/90 backdrop-blur-md border-b border-border-subtle' 
        : 'bg-transparent'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-background-near-black/95 backdrop-blur-md border-b border-border-subtle">
              <button 
                onClick={() => scrollToSection('docs')}
